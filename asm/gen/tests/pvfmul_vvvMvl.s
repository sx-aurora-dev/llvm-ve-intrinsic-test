	.text
	.file	"pvfmul_vvvMvl.c"
	.globl	pvfmul_vvvMvl                   # -- Begin function pvfmul_vvvMvl
	.p2align	4
	.type	pvfmul_vvvMvl,@function
pvfmul_vvvMvl:                          # @pvfmul_vvvMvl
# %bb.0:
	brgt.w 1, %s5, .LBB0_3
# %bb.1:
	or %s6, 0, (0)1
...
.LBB0_3:
	b.l.t (, %s10)
.Lfunc_end0:
	.size	pvfmul_vvvMvl, .Lfunc_end0-pvfmul_vvvMvl
                                        # -- End function
