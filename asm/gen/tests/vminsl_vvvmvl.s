	.text
	.file	"vminsl_vvvmvl.c"
	.globl	vminsl_vvvmvl                   # -- Begin function vminsl_vvvmvl
	.p2align	4
	.type	vminsl_vvvmvl,@function
vminsl_vvvmvl:                          # @vminsl_vvvmvl
# %bb.0:
	brgt.w 1, %s5, .LBB0_7
# %bb.1:
	or %s6, 0, (0)1
...
.LBB0_7:
	b.l.t (, %s10)
.Lfunc_end0:
	.size	vminsl_vvvmvl, .Lfunc_end0-vminsl_vvvmvl
                                        # -- End function
