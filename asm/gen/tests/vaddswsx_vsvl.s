	.text
	.file	"vaddswsx_vsvl.c"
	.globl	vaddswsx_vsvl                   # -- Begin function vaddswsx_vsvl
	.p2align	4
	.type	vaddswsx_vsvl,@function
vaddswsx_vsvl:                          # @vaddswsx_vsvl
# %bb.0:
	and %s3, %s3, (32)0
	brgt.w 1, %s3, .LBB0_10
# %bb.1:
...
.LBB0_10:
	b.l.t (, %s10)
.Lfunc_end0:
	.size	vaddswsx_vsvl, .Lfunc_end0-vaddswsx_vsvl
                                        # -- End function
