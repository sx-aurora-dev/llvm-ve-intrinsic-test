	.text
	.file	"vminswsx_vsvmvl.c"
	.globl	vminswsx_vsvmvl                 # -- Begin function vminswsx_vsvmvl
	.p2align	4
	.type	vminswsx_vsvmvl,@function
vminswsx_vsvmvl:                        # @vminswsx_vsvmvl
# %bb.0:
	and %s5, %s5, (32)0
	brgt.w 1, %s5, .LBB0_7
# %bb.1:
...
.LBB0_7:
	b.l.t (, %s10)
.Lfunc_end0:
	.size	vminswsx_vsvmvl, .Lfunc_end0-vminswsx_vsvmvl
                                        # -- End function
