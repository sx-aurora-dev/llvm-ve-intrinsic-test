	.text
	.file	"pvmins_vsvl.c"
	.globl	pvmins_vsvl                     # -- Begin function pvmins_vsvl
	.p2align	4
	.type	pvmins_vsvl,@function
pvmins_vsvl:                            # @pvmins_vsvl
# %bb.0:
	brgt.w 1, %s3, .LBB0_10
# %bb.1:
	lea %s4, -1536
...
.LBB0_10:
	b.l.t (, %s10)
.Lfunc_end0:
	.size	pvmins_vsvl, .Lfunc_end0-pvmins_vsvl
                                        # -- End function
