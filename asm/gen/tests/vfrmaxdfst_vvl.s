	.text
	.file	"vfrmaxdfst_vvl.c"
	.globl	vfrmaxdfst_vvl                  # -- Begin function vfrmaxdfst_vvl
	.p2align	4
	.type	vfrmaxdfst_vvl,@function
vfrmaxdfst_vvl:                         # @vfrmaxdfst_vvl
# %bb.0:
	brgt.w 1, %s2, .LBB0_10
# %bb.1:
	lea %s3, -768
...
.LBB0_10:
	b.l.t (, %s10)
.Lfunc_end0:
	.size	vfrmaxdfst_vvl, .Lfunc_end0-vfrmaxdfst_vvl
                                        # -- End function
