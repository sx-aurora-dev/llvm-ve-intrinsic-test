	.text
	.file	"vmaxsl_vsvmvl.c"
	.globl	vmaxsl_vsvmvl                   # -- Begin function vmaxsl_vsvmvl
	.p2align	4
	.type	vmaxsl_vsvmvl,@function
vmaxsl_vsvmvl:                          # @vmaxsl_vsvmvl
# %bb.0:
	brgt.w 1, %s5, .LBB0_7
# %bb.1:
	or %s6, 0, (0)1
...
.LBB0_7:
	b.l.t (, %s10)
.Lfunc_end0:
	.size	vmaxsl_vsvmvl, .Lfunc_end0-vmaxsl_vsvmvl
                                        # -- End function
