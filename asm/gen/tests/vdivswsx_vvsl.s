	.text
	.file	"vdivswsx_vvsl.c"
	.globl	vdivswsx_vvsl                   # -- Begin function vdivswsx_vvsl
	.p2align	4
	.type	vdivswsx_vvsl,@function
vdivswsx_vvsl:                          # @vdivswsx_vvsl
# %bb.0:
	and %s3, %s3, (32)0
	brgt.w 1, %s3, .LBB0_10
# %bb.1:
...
.LBB0_10:
	b.l.t (, %s10)
.Lfunc_end0:
	.size	vdivswsx_vvsl, .Lfunc_end0-vdivswsx_vvsl
                                        # -- End function
