	.text
	.file	"vmulsl_vvvmvl.c"
	.globl	vmulsl_vvvmvl                   # -- Begin function vmulsl_vvvmvl
	.p2align	4
	.type	vmulsl_vvvmvl,@function
vmulsl_vvvmvl:                          # @vmulsl_vvvmvl
# %bb.0:
	brgt.w 1, %s5, .LBB0_7
# %bb.1:
	or %s6, 0, (0)1
...
.LBB0_7:
	b.l.t (, %s10)
.Lfunc_end0:
	.size	vmulsl_vvvmvl, .Lfunc_end0-vmulsl_vvvmvl
                                        # -- End function
