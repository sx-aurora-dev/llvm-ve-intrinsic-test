	.text
	.file	"pvcmpu_vvvMvl.c"
	.globl	pvcmpu_vvvMvl                   # -- Begin function pvcmpu_vvvMvl
	.p2align	4
	.type	pvcmpu_vvvMvl,@function
pvcmpu_vvvMvl:                          # @pvcmpu_vvvMvl
# %bb.0:
	brgt.w 1, %s5, .LBB0_3
# %bb.1:
	or %s6, 0, (0)1
...
.LBB0_3:
	b.l.t (, %s10)
.Lfunc_end0:
	.size	pvcmpu_vvvMvl, .Lfunc_end0-pvcmpu_vvvMvl
                                        # -- End function
