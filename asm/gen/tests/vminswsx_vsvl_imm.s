	.text
	.file	"vminswsx_vsvl_imm.c"
	.globl	vminswsx_vsvl_imm               # -- Begin function vminswsx_vsvl_imm
	.p2align	4
	.type	vminswsx_vsvl_imm,@function
vminswsx_vsvl_imm:                      # @vminswsx_vsvl_imm
# %bb.0:
	brgt.w 1, %s2, .LBB0_10
# %bb.1:
	lea %s3, -768
...
.LBB0_10:
	b.l.t (, %s10)
.Lfunc_end0:
	.size	vminswsx_vsvl_imm, .Lfunc_end0-vminswsx_vsvl_imm
                                        # -- End function
