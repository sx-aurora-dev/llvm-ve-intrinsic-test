	.text
	.file	"pvfmax_vvvMvl.c"
	.globl	pvfmax_vvvMvl                   # -- Begin function pvfmax_vvvMvl
	.p2align	4
	.type	pvfmax_vvvMvl,@function
pvfmax_vvvMvl:                          # @pvfmax_vvvMvl
# %bb.0:
	brgt.w 1, %s5, .LBB0_3
# %bb.1:
	or %s6, 0, (0)1
...
.LBB0_3:
	b.l.t (, %s10)
.Lfunc_end0:
	.size	pvfmax_vvvMvl, .Lfunc_end0-pvfmax_vvvMvl
                                        # -- End function
