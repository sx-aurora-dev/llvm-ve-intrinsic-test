	.text
	.file	"vaddsl_vvvmvl.c"
	.globl	vaddsl_vvvmvl                   # -- Begin function vaddsl_vvvmvl
	.p2align	4
	.type	vaddsl_vvvmvl,@function
vaddsl_vvvmvl:                          # @vaddsl_vvvmvl
# %bb.0:
	brgt.w 1, %s5, .LBB0_7
# %bb.1:
	or %s6, 0, (0)1
...
.LBB0_7:
	b.l.t (, %s10)
.Lfunc_end0:
	.size	vaddsl_vvvmvl, .Lfunc_end0-vaddsl_vvvmvl
                                        # -- End function
