	.text
	.file	"pvaddu_vsvMvl.c"
	.globl	pvaddu_vsvMvl                   # -- Begin function pvaddu_vsvMvl
	.p2align	4
	.type	pvaddu_vsvMvl,@function
pvaddu_vsvMvl:                          # @pvaddu_vsvMvl
# %bb.0:
	brgt.w 1, %s5, .LBB0_3
# %bb.1:
	or %s6, 0, (0)1
...
.LBB0_3:
	b.l.t (, %s10)
.Lfunc_end0:
	.size	pvaddu_vsvMvl, .Lfunc_end0-pvaddu_vsvMvl
                                        # -- End function
