	.text
	.file	"pvfcmp_vvvMvl.c"
	.globl	pvfcmp_vvvMvl                   # -- Begin function pvfcmp_vvvMvl
	.p2align	4
	.type	pvfcmp_vvvMvl,@function
pvfcmp_vvvMvl:                          # @pvfcmp_vvvMvl
# %bb.0:
	brgt.w 1, %s5, .LBB0_3
# %bb.1:
	or %s6, 0, (0)1
...
.LBB0_3:
	b.l.t (, %s10)
.Lfunc_end0:
	.size	pvfcmp_vvvMvl, .Lfunc_end0-pvfcmp_vvvMvl
                                        # -- End function
