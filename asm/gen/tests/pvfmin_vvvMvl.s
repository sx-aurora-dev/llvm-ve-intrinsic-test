	.text
	.file	"pvfmin_vvvMvl.c"
	.globl	pvfmin_vvvMvl                   # -- Begin function pvfmin_vvvMvl
	.p2align	4
	.type	pvfmin_vvvMvl,@function
pvfmin_vvvMvl:                          # @pvfmin_vvvMvl
# %bb.0:
	brgt.w 1, %s5, .LBB0_3
# %bb.1:
	or %s6, 0, (0)1
...
.LBB0_3:
	b.l.t (, %s10)
.Lfunc_end0:
	.size	pvfmin_vvvMvl, .Lfunc_end0-pvfmin_vvvMvl
                                        # -- End function
