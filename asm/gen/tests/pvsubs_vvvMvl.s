	.text
	.file	"pvsubs_vvvMvl.c"
	.globl	pvsubs_vvvMvl                   # -- Begin function pvsubs_vvvMvl
	.p2align	4
	.type	pvsubs_vvvMvl,@function
pvsubs_vvvMvl:                          # @pvsubs_vvvMvl
# %bb.0:
	brgt.w 1, %s5, .LBB0_3
# %bb.1:
	or %s6, 0, (0)1
...
.LBB0_3:
	b.l.t (, %s10)
.Lfunc_end0:
	.size	pvsubs_vvvMvl, .Lfunc_end0-pvsubs_vvvMvl
                                        # -- End function
