	.text
	.file	"vaddswzx_vsvl_imm.c"
	.globl	vaddswzx_vsvl_imm               # -- Begin function vaddswzx_vsvl_imm
	.p2align	4
	.type	vaddswzx_vsvl_imm,@function
vaddswzx_vsvl_imm:                      # @vaddswzx_vsvl_imm
# %bb.0:
	brgt.w 1, %s2, .LBB0_10
# %bb.1:
	lea %s3, -768
...
.LBB0_10:
	b.l.t (, %s10)
.Lfunc_end0:
	.size	vaddswzx_vsvl_imm, .Lfunc_end0-vaddswzx_vsvl_imm
                                        # -- End function
