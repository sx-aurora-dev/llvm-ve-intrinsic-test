	.text
	.file	"pvadds_vvvMvl.c"
	.globl	pvadds_vvvMvl                   # -- Begin function pvadds_vvvMvl
	.p2align	4
	.type	pvadds_vvvMvl,@function
pvadds_vvvMvl:                          # @pvadds_vvvMvl
# %bb.0:
	brgt.w 1, %s5, .LBB0_3
# %bb.1:
	or %s6, 0, (0)1
...
.LBB0_3:
	b.l.t (, %s10)
.Lfunc_end0:
	.size	pvadds_vvvMvl, .Lfunc_end0-pvadds_vvvMvl
                                        # -- End function
