	.text
	.file	"pvcmps_vvvMvl.c"
	.globl	pvcmps_vvvMvl                   # -- Begin function pvcmps_vvvMvl
	.p2align	4
	.type	pvcmps_vvvMvl,@function
pvcmps_vvvMvl:                          # @pvcmps_vvvMvl
# %bb.0:
	brgt.w 1, %s5, .LBB0_7
# %bb.1:
...
.LBB0_7:
	b.l.t (, %s10)
.Lfunc_end0:
	.size	pvcmps_vvvMvl, .Lfunc_end0-pvcmps_vvvMvl
                                        # -- End function
