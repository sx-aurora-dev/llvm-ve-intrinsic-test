	.text
	.file	"vfcmpd_vsvmvl.c"
	.globl	vfcmpd_vsvmvl                   # -- Begin function vfcmpd_vsvmvl
	.p2align	4
	.type	vfcmpd_vsvmvl,@function
vfcmpd_vsvmvl:                          # @vfcmpd_vsvmvl
# %bb.0:
	brgt.w 1, %s5, .LBB0_7
# %bb.1:
	or %s6, 0, (0)1
...
.LBB0_7:
	b.l.t (, %s10)
.Lfunc_end0:
	.size	vfcmpd_vsvmvl, .Lfunc_end0-vfcmpd_vsvmvl
                                        # -- End function
