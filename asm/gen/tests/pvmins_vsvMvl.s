	.text
	.file	"pvmins_vsvMvl.c"
	.globl	pvmins_vsvMvl                   # -- Begin function pvmins_vsvMvl
	.p2align	4
	.type	pvmins_vsvMvl,@function
pvmins_vsvMvl:                          # @pvmins_vsvMvl
# %bb.0:
	brgt.w 1, %s5, .LBB0_3
# %bb.1:
	or %s6, 0, (0)1
...
.LBB0_3:
	b.l.t (, %s10)
.Lfunc_end0:
	.size	pvmins_vsvMvl, .Lfunc_end0-pvmins_vsvMvl
                                        # -- End function
