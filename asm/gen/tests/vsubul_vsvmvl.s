	.text
	.file	"vsubul_vsvmvl.c"
	.globl	vsubul_vsvmvl                   # -- Begin function vsubul_vsvmvl
	.p2align	4
	.type	vsubul_vsvmvl,@function
vsubul_vsvmvl:                          # @vsubul_vsvmvl
# %bb.0:
	brgt.w 1, %s5, .LBB0_7
# %bb.1:
	or %s6, 0, (0)1
...
.LBB0_7:
	b.l.t (, %s10)
.Lfunc_end0:
	.size	vsubul_vsvmvl, .Lfunc_end0-vsubul_vsvmvl
                                        # -- End function
