	.text
	.file	"vsubuw_vvvmvl.c"
	.globl	vsubuw_vvvmvl                   # -- Begin function vsubuw_vvvmvl
	.p2align	4
	.type	vsubuw_vvvmvl,@function
vsubuw_vvvmvl:                          # @vsubuw_vvvmvl
# %bb.0:
	brgt.w 1, %s5, .LBB0_7
# %bb.1:
...
.LBB0_7:
	b.l.t (, %s10)
.Lfunc_end0:
	.size	vsubuw_vvvmvl, .Lfunc_end0-vsubuw_vvvmvl
                                        # -- End function
