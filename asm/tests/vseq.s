...
.LBB0_2:
	...
	b.l (,%lr)
.Lfunc_end0:
	.size	vseq, .Lfunc_end0-vseq

	.globl	vseq_p
	.p2align	4
	.type	vseq_p,@function
vseq_p:
	st %s9, (,%s11)
	st %s10, 8(,%s11)
	st %s15, 24(,%s11)
...
.LBB1_2:
	...
	b.l (,%lr)
.Lfunc_end1:
	.size	vseq_p, .Lfunc_end1-vseq_p

	.globl	vseq_pl
	.p2align	4
	.type	vseq_pl,@function
vseq_pl:
	st %s9, (,%s11)
	st %s10, 8(,%s11)
	st %s15, 24(,%s11)
...
.LBB2_2:
	...
	b.l (,%lr)
.Lfunc_end2:
	.size	vseq_pl, .Lfunc_end2-vseq_pl

	.globl	vseq_pu
	.p2align	4
	.type	vseq_pu,@function
vseq_pu:
	st %s9, (,%s11)
	st %s10, 8(,%s11)
	st %s15, 24(,%s11)
...
.LBB3_2:
	...
	b.l (,%lr)
.Lfunc_end3:
	.size	vseq_pu, .Lfunc_end3-vseq_pu
